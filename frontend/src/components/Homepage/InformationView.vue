      ...
      <div class="container">
        ...
        <div class="row align-items-center g-5">
          ...
          <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
            ...
            <!-- Content -->
            <p class="my-4 lead">Retrouver les différentes bases de donnés de matériels de scénarios de simulation et des dates importantes du groupe de travail de simulation de la Haute école de Santé Valais</p>


            <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
              <!-- Button -->
              <a href="#" class="btn btn-lg btn-primary-soft me-2 mb-4 mb-sm-0">Plus d'info</a>
            </div>
          </div>
          <!-- Left content END -->
          ...
          <div class="col-lg-7 col-xl-6 text-center position-relative">
            ...
            <div class="position-relative">
              <img class="img-nruse" src="/src/assets/images/heds/image/nurseHomePage.png" alt="">
            </div>
          </div>
          <!-- Right content END -->
        </div>
