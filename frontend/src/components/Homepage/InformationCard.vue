            ...
            <div class="row position-relative">
              ...
              <div class="col-11 mx-auto position-relative">
                <div class="row align-items-center">
                  <!-- Title -->
                  <div class="col-lg-7">
                    <h3 class="text-white">Base de données du matériels</h3>
                    <p class="text-white mb-3 mb-lg-0">Base de données des matériels de la HEdS pour du recensement et du prêt</p>
                  </div>
                  <!-- Content and input -->
                  <div class="col-lg-5 text-lg-end">
                    <a href="#" class="btn btn-outline-warning mb-0">Commencer à réserver</a>
                  </div>
                </div>
              </div>
            </div> <!-- Row END -->
