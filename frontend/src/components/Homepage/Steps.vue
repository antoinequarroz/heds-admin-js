<template>
  <section class="position-relative pt-0 pt-lg-5 pb-5 bg-secondary-subtle p-4 overflow-hidden h-100">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="text-center">
          <h2>Comment louer du matériel</h2>
        </div>
      </div>
...
export default {
  name: 'Steps'
  // Ici, vous pouvez ajouter des données, des méthodes, etc.
};
</script>
